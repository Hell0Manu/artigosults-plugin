// src/services/posts/posts.mock.repository.ts
import type { PostsRepository } from "../../domain/post/posts.repository";
...
export class PostsMockRepository implements PostsRepository {
  ...
  async getAuthors(): Promise<Author[]> {
    ...
    return Object.values(MOCK_AUTHORS);
  }
...
// Exportamos uma instância singleton para usar na app
export const postsService = new PostsMockRepository();